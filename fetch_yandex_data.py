...
AIRPORTS = [
    ...
    {'iata': 'RND', 'icao': 'URRP', 'name': 'Платов (Ростов)',   'yandex_code': 's9866615'},
...
def main():
    ...
    empty_airports = [a['name'] for a in AIRPORTS if result['airports'].get(a['icao'], {}).get('arrivals') == [] and result['airports'].get(a['icao'], {}).get('departures') == []]
    if empty_airports:
